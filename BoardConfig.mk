...
# Kernel
TARGET_PREBUILT_KERNEL := device/samsung/d1q/prebuilt/Image.gz-dtb
BOARD_PREBUILT_DTBOIMAGE := device/samsung/d1q/prebuilt/recoverydtbo
...
BOARD_CUSTOM_BOOTIMG_MK := device/samsung/d1q/bootimg.mk
